class YoutubeInator {
  ...
  change_text() {
    ...
    let all_links = document.getElementsByClassName(
  ...
  change_dates() {
    let all_dates = document.getElementsByClassName(
      'date style-scope ytd-video-secondary-info-renderer'
    )
    ...
    for (let weird_img of all_weird_images) {
      ...
      new_elem.src =
        this.possible_images[
          Math.ceil(Math.random() * this.possible_images.length)
        ]
  ...
  change_views() {
    let recommended_view_count = document.getElementsByClassName(
      'style-scope ytd-video-meta-block'
    )
    let main_view_count = document.getElementsByClassName(
  ...
  change_recommended() {
    let video_titles = document.getElementsByClassName(
...
let urls = [
  'https://orig00.deviantart.net/32bd/f/2018/245/4/0/untitled_drawing_by_azuraring-dcltymr.png',
  'https://www.pngfind.com/pngs/m/183-1831028_mlg-mlg-mlg-8-bit-finn-the-human.png',
  'https://i.kym-cdn.com/entries/icons/original/000/027/027/5gwo9dcm1rh11.png',
  'https://i.ytimg.com/vi/0NfTVytat_E/maxresdefault.jpg',
  'https://i.kym-cdn.com/entries/icons/original/000/030/115/cover4.jpg',
  'https://i.kym-cdn.com/entries/icons/original/000/021/971/Salt-Bae-001.jpg',
  'https://images-i.jpimedia.uk/imagefetch/c_fill,f_auto,h_1133,q_auto:eco,w_1700/https://inews.co.uk/wp-content/uploads/2016/09/pepehead.jpg',
  'https://i1.wp.com/chartcons.com/wp-content/uploads/Funniest-Ginger-Jokes-3.jpg?fit=1024%2C768&ssl=1',
  'https://www.24fun.me/wp-content/uploads/2019/05/Funny-videos-2017-funny-vines-try-not-to-laugh-challenge.jpg',
  'https://image.shutterstock.com/image-photo/funny-man-watermelon-helmet-googles-260nw-157354478.jpg',
]
setTimeout(function () {
